# the setUpMainWindow() method for using checkboxes
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        morning_cb.move(40, 80)
        morning_cb.toggle()
        morning_cb.toggle.connect(self.printSelected)

        after_cb = QCheckBox('afternoon 1 pm 8 pm', self)
        after_cb.move(40, 80)
        after_cb.toggle.connect(self.printSelected)

        night_cb = QCheckBox('night 7 pm 3 am ', self)
        night_cb.move(40, 100)
        night_cb.toggle.connect(self.printSelected)
